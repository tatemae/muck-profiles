...
Gem::Specification.new do |s|
  s.name = "muck-profiles"
  s.version = "3.1.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Justin Ball", "Joel Duffin"]
  s.date = "2011-09-21"
  s.description = "Profile engine for the muck system."
  ...
  s.homepage = "http://github.com/tatemae/muck-profiles"
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "Profile engine for the muck system"
